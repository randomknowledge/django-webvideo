...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WebVideo.owner'
        db.add_column(u'django_webvideo_webvideo', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'VideoScreen.owner'
        db.add_column(u'django_webvideo_videoscreen', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ConvertedVideo.owner'
        db.add_column(u'django_webvideo_convertedvideo', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WebVideo.owner'
        db.delete_column(u'django_webvideo_webvideo', 'owner_id')

        # Deleting field 'VideoScreen.owner'
        db.delete_column(u'django_webvideo_videoscreen', 'owner_id')

        # Deleting field 'ConvertedVideo.owner'
        db.delete_column(u'django_webvideo_convertedvideo', 'owner_id')
